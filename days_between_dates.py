...
def countDaysBefore(year, month, day):
    ...
    days += int(countLeapYear(year, month))
...
print(days_between_dates(int(date1List[0]), int(date1List[1]), int(date1List[2]),
                         int(date2List[0]), int(date2List[1]), int(date2List[2])))
